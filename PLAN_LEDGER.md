...
| 57 | 2026-07-12 | **B10-B** Capstone class | Advanced class teaser | **Capstone EKSKLUSIF per class**; nama disetujui: **Worldbreaker / Astral Genesis / Throne of Souls / Ancient Beast Pact** (+6 draft lain — MENUNGGU FILE blueprint) | Amandemen Direktur | Owner/Direktur |
...
| 66 | 2026-07-12 | **B19** World Personality | Wilayah = bioma + monster | **Enam Lingkup Budaya** (tabel blueprint §3.9 — MENUNGGU FILE): berpindah wilayah = berpindah budaya (arsitektur/musik/dialek/quest/hukum/pohon lokal). **KOREKSI PENOMORAN dicatat eksplisit: Direktur menulis "B14" untuk butir ini, tetapi B14 = GRATIS PENUH; nomor benar = B19** | Amandemen Direktur (+koreksi nomor oleh agent, disahkan direktif) | Owner/Direktur |
