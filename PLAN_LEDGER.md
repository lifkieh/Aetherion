...
| 82 | 2026-07-13 | **E10 [PENDING OWNER P1–P5]** | Lima pertanyaan konflik belum diputus | **P1** ras 8-besar (final atau bisa bertambah?); **P2** revive NPC (boleh/tidak — bertabrakan dengan Loss & Chronicle); **P3** pernikahan pemain; **P4** scope simulasi (seberapa dalam dunia berjalan sendiri); **P5** wilayah elf/dwarf/fairy + Thalassar. **LARANGAN: jangan implementasikan apa pun yang bergantung pada P1–P5 sampai owner memutuskan** | Menunggu owner | ⏳ PENDING OWNER |
