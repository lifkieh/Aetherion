...
signal fusion_discovered(result_name: String, desc: String)
signal skill_cast(skill_id: String)
signal boss_engaged(display_name: String, node)
signal boss_hp_changed(cur: int, max: int)
signal boss_defeated(display_name: String)
