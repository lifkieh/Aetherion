...
| **Pixel Art Top Down — Basic v1.2.3** | Cainos (itch.io) | Free (CC-BY-style; kredit dianjurkan) — cek berkas lisensi pack sebelum rilis | Ya (kredit Cainos) | Tileset & props top-down (dressing kota/dungeon) | **Reserved** — belum dipakai (gaya perlu penyesuaian palet; dinilai ulang di pass parallax/dressing) |
